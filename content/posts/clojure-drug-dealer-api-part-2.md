...
In the [last part](https://shivekkhurana.com/blog/clojure-drug-dealer-part-1)  we created a simple app structure to handle a drug store. A drug store  had an inventory, each drug had a price, procurement was via offline  sources and there was a retail window.
